...
+ (ImageScrollView *)returnImageScrollViewWithFrame:(CGRect)frame imageUrl:(NSArray *)imageUrls placeholderImageName:(NSString *)placeholderImageName isAutoScroll:(BOOL)isAutoScroll scrollTime:(NSInteger)scrollTime{
    ...
    return [[[self class]alloc]initWithFrame:frame imageUrl:imageUrls placeholderImageName:placeholderImageName isAutoScroll:isAutoScroll scrollTime:scrollTime];
}
...
+ (ImageScrollView *)returnImageScrollViewWithFrame:(CGRect)frame imageUrl:(NSArray *)imageUrls isAutoScroll:(BOOL)isAutoScroll{
    ...
    return [[[self class]alloc]initWithFrame:frame imageUrl:imageUrls placeholderImageName:PLACEHOLDER_NAME isAutoScroll:isAutoScroll scrollTime:SCROLLTIME];
}
...
- (instancetype)initWithFrame:(CGRect)frame imageUrl:(NSArray *)imageUrls placeholderImageName:(NSString *)placeholderImageName isAutoScroll:(BOOL)isAutoScroll scrollTime:(NSInteger)scrollTime{
